...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="pross/add.php?id=<?php echo $role_id; ?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="fullName" class="form-label">Họ và tên</label>
                <input type="text" class="form-control" name="full_name" id="fullName" required placeholder="Nhập Họ tên">
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" name="address" id="address" required placeholder="Nhập Địa chỉ"></input>
            </div>

            <div class="mb-3">
                <label for="idCardNumber" class="form-label">Mã số căn cước công dân</label>
                <input type="text" class="form-control" name="citizen_id" id="idCardNumber" required placeholder="Nhập CCCD">
            </div>

            <div class="mb-3">
                <label for="idCardImage" class="form-label">Tải ảnh thẻ lên</label>
                <input type="file" class="form-control" name="image" id="idCardImage" accept="image/*" required>
            </div>
