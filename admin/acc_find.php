                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="acc_edit.php?user_id=<?php echo $row['user_id']; ?>&role_id=1&role_name=student">Sửa</a>
                                    <a class="btn btn-danger btn-sm" onclick="return Del('<?php echo $row['full_name']; ?>')" href="pross/delete.php?user_id=<?php echo $row['user_id']; ?>&role_id=1">Xóa</a>
                                    <a class="btn btn-info btn-sm" href="acc_view.php?user_id=<?php echo $row['user_id']; ?>&role_id=1&role_name=student">Thông tin</a>
                                </td>
                            </tr>
                        <?php
                        }
