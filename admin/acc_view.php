    ...
    <header class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <a class="btn btn-primary rounded-end rounded-start" type="button" href="acc_edit.php?user_id=<?php echo $row['user_id'];
                ?>&role_id=<?php echo $row['role_id'];?>&role_name=<?php echo $row['role_name'];?>">Thay đổi thông tin</a>
