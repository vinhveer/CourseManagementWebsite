...
// Initialize $result to avoid undefined variable warning
    ...
    WHERE course_id = $course_id AND BINARY us.full_name LIKE '%".$tukhoa."%'";
...
<body>
    <header class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-6">
            <form class="d-flex" action="course_member_find.php" method="GET" >
                    <input class="form-control me-2" type="search" placeholder="Tìm kiếm tên thành viên" aria-label="Tìm kiếm" name="tukhoa" >
