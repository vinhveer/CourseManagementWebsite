...
<body>
    ...
    <div class="container mt-5">
        <form id="scheduleForm" action="pross/c_add.php" method="post" class="needs-validation" novalidate>
            ...
            <div class="mb-3 row">
                <div class="col-sm-12">
                    ...
                    <button type="submit" class="btn btn-primary" name="add_schedule">Lưu thời khóa biểu</button>
                    <a href="success_create_course.php" type="button" class="btn btn-secondary">Không thêm ngay bây giờ</a>
                </div>
            </div>
        </form>
    </div>
