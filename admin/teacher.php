...
<body>
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-4">
                <form class="d-flex" action="teacher.php" method="POST">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger float-end me-2" data-postid="<?php echo $row_teacher_account['user_id']; ?>" data-bs-toggle="modal" data-bs-target="#deleteCourseModal">Xóa</button>
                                    <a class="btn btn-info float-end me-2" href="account_edit.php?user_id=<?php echo $row_teacher_account['user_id']; ?>&role_id=2&role_name=teacher">Sửa</a>
                                    <a class="btn btn-info float-end me-2" href="account_view.php?user_id=<?php echo $row_teacher_account['user_id']; ?>&role_id=2&role_name=teacher">Thông tin</a>
                                </td>
                            </tr>
                        <?php
                        }
