        ...
        <div class="row">
            ...
            <div class="col-6 col-md">
                ...
                <ul class="list-unstyled text-small">
                    ...
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Khóa học của tôi</a></li>
                    <li class="mb-1"><a class="link-secondary text-decoration-none" href="index.php">Trang chủ khóa học</a></li>
                </ul>
            </div>
            <div class="col-6 col-md">
