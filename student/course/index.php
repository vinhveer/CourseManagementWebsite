    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="loadContent('post')">Bài đăng</a>
          </li>
          <li>
            <a href="#" class="nav-link" onclick="loadContent('content')">Học liệu</a>
          </li>
          <li>
            <a href="#" class="nav-link" onclick="loadContent('exam')">Bài tập và kiểm tra</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="loadContent('messages')">Nhắn tin</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="loadContent('grade')">Điểm số</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="loadContent('member')">Thành viên</a>
          </li>
