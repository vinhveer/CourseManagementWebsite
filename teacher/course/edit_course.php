        ...
        <div class="container mt-5">
            <form id="createCourseForm" action="process.php" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="hidden" id="course_background_hidden" value="<?php echo $row_course['course_background']; ?>">

                        <!-- File input for image selection -->
                        <input type="file" class="form-control" id="course_image" name="course_image" accept="image/*" required>
                        <div class="invalid-feedback">
                            Vui lòng chọn ảnh bìa khóa học (tối đa 20MB và chỉ chấp nhận file hình ảnh).
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <div class="col-sm-12 text-end">
                    <button type="submit" class="btn btn-primary" name="add_course">Lưu</button>
